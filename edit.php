...
$update=mysqli_query($con,"UPDATE usertable1 SET image='".$file_name."' WHERE id='" . $_GET['id'] . "'");  
...
city='" . $_POST['city'] . "',
state='" . $_POST['state'] . "',
country='" . $_POST['country'] . "' WHERE id='" . $_GET['id'] . "'");
$message = "Record Modified Successfully";
}
$result = mysqli_query($con,"SELECT * FROM usertable1 WHERE id='" . $_GET['id'] . "'");
...
<div style="padding-bottom:5px;">
    ...
    <div class="input-container">
            ...
            value="<?php echo $row['user'] ?>" style="margin-left:1.5%">
    </div>
    </td>
    </tr>
    <br>
    ...
    <td>
        ...
        <input type="text" name="email" placeholder="Enter Email"  size="53" value="<?php echo $row['email'] ?>" style="margin-left:1.5%">
    </div>
    </td>
    </tr>
    ...
    <input type="text" name="password" placeholder="Password" size="53" style="margin-left:2%" 
    ...
    <input type="date" name="dob" placeholder="Enter Date" style="margin-left:4%"
		...
		<tr><td><div class="input-container">
			...
			<select name="country"  value="<?php echo $row['country'];?>" style="margin-left:4.1% ;" id="countyList">
			...
			<select name="state"  value="<?php echo $row['state'];?>" style="margin-left: 3%;" id="stateList">
            ...
            <tr><td><div class="input-container">
	            <i class="fas fa-city" style="font-size:24px; margin-left:3%"></i>
		        <select name="city"  value="<?php echo $row['city'];?>" style="margin-left:3%" id="cityList"> 
    ...
    <tr><td>
        ...
        <!-- <a href="welcome.php" class="btn btn-primary" style=" position: relative; text-decoration:none;">Back </a>        -->
        <a href="welcome.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary" class="back" 
...
if(isset ($_GET['id'])) {
   ...
   if(isset($_POST['submit'])){
	...
	//   $image = $_FILES['image'];
	  ...
	  if (file_exists($image_store))
    	{
    	@unlink("profile/".$image_name);

		}

		move_uploaded_file($image_tmp,"profile/".$image_name);
		$update=mysqli_query($con,"UPDATE usertable SET image='".$image_name."' WHERE id='" . $_GET['id'] . "'");  
   	$s = "UPDATE usertable
   SET user = '$user' ,email = '$email' , password = '$password' , dob = '$dob', gender ='$gender', city = '$city', state = '$state' , country = '$country' 
   				WHERE id= '$id' ";
